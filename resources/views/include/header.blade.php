        ...
        <div class="dt-brand">
            ...
            <span class="dt-brand__logo">
                <a class="dt-brand__logo-link" href="index-2.html">
                    <img class="dt-brand__logo-img d-none d-lg-inline-block" src="{{ 'storage/'.LOGO_PATH.config('sittings.logo') }}" alt="Wieldy">
                    <img class="dt-brand__logo-symbol d-lg-none" src="{{ 'storage/'.LOGO_PATH.config('sittings.logo') }}" alt="Wieldy">
                </a>
            </span>
            <!-- /brand logo -->
                    ...
                    <li class="dt-nav__item dropdown">
                        ...
                        <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                            ...
                            @if (Auth::user()->avatar)
                                <img class="dt-avatar size-40"
                                    src="storage/{{ USER_AVATAR_PATH . auth::user()->avatar }}" alt="Domnic Harris">

                            @else
                                <img class="dt-avatar size-40"
                                    src="images/{{ Auth::user()->gender == 1 ? 'male.png' : 'female.png' }}"
                                    alt="{{ Auth::user()->name }}">
                            @endif
                        </a>
                        <!-- /dropdown link -->
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div
                                ...
                                @if (auth::user()->avatar)
                                    <img class="dt-avatar size-40"
                                        src="storage/{{ USER_AVATAR_PATH . auth::user()->avatar }}"
                                        alt="Domnic Harris">
