            ...
            <div class="col-xl-12">
                ...
                <div class="dt-entry__header">
                    ...
                    <div class="dt-entry__heading">
                        <a href="{{ route('role.create') }}" class="btn btn-primary btn-sm" type="button"><i
                                class="fas fa-plus-square"></i> Add Role
                        </a>
                    </div>
                    <!-- /entry heading -->
                        ...
                        <form id="form-fillter">
                            <div class="row">
                                <div class="form-group col-6 ">
                                    <label for="menu_name">Role Name</label>
                                    <input class="form-control form-control-sm" type="text" name="role_name" id="role_name"
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ url('role/data-table') }}",
                    "type": "POST",
                    "data": function(data) {
                        data.role_name = $('#form-fillter #role_name').val();
                        data._token = _token;
                    }
                },
            ...
            $('#btn_fillter').click(function() {
                var role_name = $('#form-fillter #role_name').val();
                if (role_name == '') {
