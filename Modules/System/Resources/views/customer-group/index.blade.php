                        ...
                        <form id="form-fillter">
                            <div class="row">
                                <div class="form-group col-6 ">
                                    <label for="menu_name"> Group Name</label>
                                    <input class="form-control form-control-sm" type="text" name="group_name" id="group_name"
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ url('customer-group/data-table') }}",
                    "type": "POST",
                    "data": function(data) {
                        data.group_name = $('#form-fillter #group_name').val();
                        data._token = _token;
                    }
                },
            ...
            $('#btn_fillter').click(function() {
                var name = $('#form-fillter #group_name').val();
                if (name == '') {
            ...
            $(document).on('click', '.save_btn', function() {
                ...
                let url = "{{ route('customer.group.store.update') }}";
            ...
            $(document).on('click', '.user_edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#store_or_update_form #parcentage').val(data.parcentage);
            ...
            $(document).on('click', '.change_status', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('customer.group.status') }}",
                            type: 'POST',
                            data: {
                                id: id,
                                status : status,
