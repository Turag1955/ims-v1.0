                        ...
                        <form id="form-fillter">
                            <div class="row">
                                <div class="form-group col-md-3 ">
                                    <label for="customer_group_id">Customer</label>
                                    <select name="customer_group_id" id="customer_group_id" class="form-control  selectpicker" data-live-search="true" data-live-search-placeholder="Search">
                                ...
                                <div class="col-md-12  pt-24 mb-5 text-right">
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ url('customer/data-table') }}",
                    "type": "POST",
                    "data": function(data) {
                        data.customer_group_id = $('#form-fillter #customer_group_id').val();
                        data.name              = $('#form-fillter #name').val();
                        data.phone             = $('#form-fillter #phone').val();
            ...
            $(document).on('click', '.save_btn', function() {
                ...
                let url = "{{ route('customer.store.update') }}";
            ...
            $(document).on('click', '.user_show', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#show_modal .modal-header').text(name + ' - Details');
                    }
                });
