            ...
            <form id="store_or_update_form" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <x-form.selectbox col="col-md-6" label="Customer Group" name="customer_group_id"
                        ...
                        <x-form.textbox type="text" col="col-md-6" label="Tax No." name="tax_number" placeholder="Tax No." />
                        ...
                        <x-form.textbox type="text" col="col-md-6" label="Postal Code" name="postal_code"
                            placeholder="Postal Code" />
                        <x-form.textbox type="text" col="col-md-6" label="Country" name="country"
                            placeholder="Country " />
                        <x-form.textarea type="textarea" col="col-md-6" label="Address" name="address"
