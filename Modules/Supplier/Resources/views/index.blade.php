                    ...
                    <div class="dt-card__body">
                        ...
                        <form id="form-fillter">
                            <div class="row">
                                ...
                                <div class="col-md-3  pt-24 text-right">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.save_btn', function() {
                ...
                let url = "{{ route('supplier.store.update') }}";
